...
<div class="tw-card">
    <form method="POST" action="{{ route('admin.v1.access.permission.update', $permission->id) }}?_method=PUT">
        @csrf
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select id="method" name="method" class="form-control @error('method') is-invalid @enderror" required>
                    ...
                    <option value="{{ $m }}" {{ old('method', $permission->method) === $m ? 'selected' : '' }}>{{ $m }}</option>
                    @endforeach
                </select>
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="desc" name="desc" class="form-control @error('desc') is-invalid @enderror"
                          rows="2">{{ old('desc', $permission->desc) }}</textarea>
